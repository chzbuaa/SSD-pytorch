...
parser.add_argument('--imagesetfile',
                    ...
                    #谷立群 default="/media/linc/data1/data_set/power_bank/VOC2012/ImageSets/Main/test.txt", type=str,
                    default="D:\\study\\document\\power-bank-detect-on-pytorch-with-ssd-master\\VOC2012\\ImageSets\\Main\\test.txt", type=str,
...
def reset_args(EPOCH):
    global args
    args.trained_model = "/media/linc/data1/work/pycode/ssd.pytorch/weights/ssd300_COCO_{:d}.pth".format(
        EPOCH)
    saver_root = '/media/linc/data1/work/pycode/ssd.pytorch/save/'
